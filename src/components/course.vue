...
var timeGet = function (time) {
    var regans = /(\d+):(\d+)/g.exec(time);
    return regans[1] * 60 + 1 * regans[2];
};
var intervalGet = function (twotimes) {
...
export default {
  ...
  methods: {
    create: function () {
      ...
      var color = ['#FDF3E7', '#DFE2DB', '#FFF056', '#F3FAB6', '#CBE32D',
                   '#ECECEA', '#92E1C0', '#FAD165', 'rgb(179, 220, 108)',
                   '#42D692', 'rgb(255, 173, 70)', 'rgb(154, 156, 255)',
                   '#B99AFF'];
